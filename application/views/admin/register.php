...
?>
 ...
 <form action="<?php echo site_url(); ?>Admin/registerAdd" method="post" id="" enctype="multipart/form-data">
<fieldset>                     
<div class="form-group col-md-12">
    ...
    <div class="form-group col-md-12">
    <label for="inputState">Roll</label>
    <select id="inputState" class="form-control" name="role">
        <option>m_staff</option>
        <option>c_staff</option>   
      </select>
    </div>
